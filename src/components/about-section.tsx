        ...
        <CardBody className="gap-8 p-4 md:p-8">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="flex-1">
              ...
              >
                ...
                <Button
                  as="a"
                  href="https://drive.google.com/file/d/1vUgdr1SGoJ4bpODKfwJlXLLmHAYL3uFV/view?usp=sharing"
                  variant="flat"
                  target="_blank"
                  color="secondary"
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {[
                "HTML5", "CSS3", "Bootstrap", "SASS/SCSS", "JavaScript", "TypeScript",
                "Angular", "Responsive Design", "Git", "GitHub",
                "Python", "C Programming", "SQLite", "jQuery", "React", "Tailwind CSS",
              ].map((skill) => (
                <div
                  key={skill}
