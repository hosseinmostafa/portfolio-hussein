  ...
  const education = [
    {
      ...
      description: "Bachelor's degree in Management Information Systems, Studied core concepts in information systems, data management, system analysis, and IT project planning. Developed strong technical and analytical skills to bridge the gap between technology and business operations. Completed coursework in databases, programming, and decision support syste"
    }
  ];
  ...
  const certifications = [
    {
      ...
      date: "2025",
      progress: 100,
      src: "https://drive.google.com/file/d/1GqgI0ItY_-0b1vSjw3M3FcrV7-KSIqar/view?usp=sharing"
    },
    {
    ...
    {
      name: "Introducing Web Developer",
      issuer: "Google Developer Groups on Campus - GGV",
      date: "2025",
      progress: 100,
    ...
    {
      name: "Intoduction Cyber Security",
      issuer: "Google Developer Groups on Campus - GGV",
      date: "2025",
      progress: 40,
      src: "https://drive.google.com/file/d/1rE-qJJaFvx3IjHDmySye_6JhnLXPMQaL/view?usp=drive_link"
    }
  ];
